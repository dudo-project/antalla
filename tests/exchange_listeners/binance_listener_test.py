...
class BinanceListenerTest(unittest.TestCase):
    ...
    def test_parse_depth_update(self):
        ...
        self.assertEqual(order_0.exchange_id, self.dummy_exchange.id)
        ...
        self.assertEqual(order_0.order_type, "bid")
        self.assertEqual(order_2.exchange_id, self.dummy_exchange.id)
    ...
    def test_parse_markets(self):
        ...
        self.assertEqual(insert_markets.items[0].first_coin_id, "ETH")
        ...
        self.assertEqual(insert_markets.items[1].first_coin_id, "LTC")
        self.assertEqual(insert_markets.items[1].second_coin_id, "BTC")
